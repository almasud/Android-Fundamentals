...
public class LocationPermissionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            startActivity(new Intent(LocationPermissionActivity.this, ClusterCurrentNearByPlacesGeofenceActivity.class));
            finish();
        }

        grantBtn = findViewById(R.id.btn_location_grant);
